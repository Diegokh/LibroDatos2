...
public class LibroDatos {
    ...
    public static void Borrar_DatosLibro(String isbn) throws Exception{
        ...
        /**
         * Realiza la programación completa de este método para encontrar y borrar los datos de un 
         * libro, dado el número de isbn por parámetro
         * Es decir que a partir del valor del isbn pasado como parámetro (String isbn) borrar
         * el resto de datos de este libro, el nombre, isbn y descripción
         * 
         * Puede utilizarse el método de LinkedList: DatosLibro.indexOf(isbn), con el que
         * obtener el indice en la lista donde se encuentra ese dato del registro de ese libro;
         * y despues como sabemos que el isbn está en 2º lugar, y en 1er lugar el nombre, y en 3er
         * lugar la descripción borrarlos todos
         * 
         * La forma de borrar debe ser mediante el metodo .remove(indice) de la propia lista LinkedList
         * es decir DatosLibro.remove(indice)
         * 
        */
